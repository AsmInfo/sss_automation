    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">Navigation graphics are graphical user interfaces that help you navigate.</h1>
          <h2 data-aos="fade-up" data-aos-delay="400">and interact with your BAS system. We Can Delivery an immersive experience to every screen your customer use.</h2>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-box blue">
              ...
              <h3>Tridium  N4 Database & Graphics Services</h3>
            ...
            <div class="row gy-4">
              <div class="col-md-6">
                <div class="info-box">
                  ...
                  <h3>Address</h3>
                  <p>Vasu Deva Nallur, <br/>Tenkasi 535022</p>
				  <p>Tamilnadu</p>
                </div>
              </div>
              <div class="col-md-6">
